...
# === EXPLANATION ===
# Removes certain amount of photos and categories from the dataset so
# that the dataset is more managable to be trained
...
print(f"\nMoved {deleted_train} train and {deleted_val} val images to '{trash_dir}'.")
